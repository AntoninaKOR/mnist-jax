...
def parse_args():
    ...
    parser.add_argument(
        ...
        action='store_true',
        help='Enable gradient accumulation via optax.MultiSteps',
    )
    parser.add_argument(
        '--accum-steps',
        type=int,
...
def main():
    ...
    if args.gradient_accumulation:
        tx = optax.MultiSteps(base_tx, every_k_schedule=args.accum_steps)
    else:
        tx = base_tx
    ...
    if args.gradient_accumulation:
        effective_batch_size = batch_size * args.accum_steps
        print(
            f'Gradient accumulation: {args.accum_steps} steps, '
